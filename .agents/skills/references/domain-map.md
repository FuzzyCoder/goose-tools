...
**Skills:**
- `deploy-goose-tools` — scaffold goose-tools into a new repo, update an existing one, install globals, switch scaffold profiles, run doctor

**Examples:**
- "Scaffold goose-tools into my repo." [deploy-goose-tools]
- "Update goose-tools in `/path/to/myproject`." [deploy-goose-tools]
- "Install goose-tools globals on this machine." [deploy-goose-tools]
- "Switch my repo to the `core` scaffold profile." [deploy-goose-tools]

**Gap:** No deploy/adoption skill installed — scaffold one with `deploy-goose-tools` from goose-tools.
